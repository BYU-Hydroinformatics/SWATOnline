    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.swatdv"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.swatdv.tests.tests"

        To run tests in the SwatdvTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.swatdv.tests.tests.SwatdvTestCase"

        To run only the test_if_tethys_platform_is_great function in the SwatdvTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.swatdv.tests.tests.SwatdvTestCase.test_if_tethys_platform_is_great"
...
class SwatdvTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Swatdv)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Swatdv)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/swatdv/')  # The final '/' is essential for all pages/controllers
